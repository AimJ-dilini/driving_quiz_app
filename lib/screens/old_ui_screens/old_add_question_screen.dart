...
class OldAddQuestionScreen extends StatefulWidget {
  final Question? editingQuestion;
  final int? indexToEdit;

  const OldAddQuestionScreen({super.key, this.editingQuestion, this.indexToEdit});

  @override
  State<OldAddQuestionScreen> createState() => _OldAddQuestionScreenState();
}

class _OldAddQuestionScreenState extends State<OldAddQuestionScreen> {
