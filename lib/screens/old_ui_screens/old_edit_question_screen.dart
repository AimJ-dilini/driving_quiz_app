...
class OldEditQuestionScreen extends StatefulWidget {
  final Question question;
  final int index;

  const OldEditQuestionScreen({super.key, required this.question, required this.index});

  @override
  State<OldEditQuestionScreen> createState() => _OldEditQuestionScreenState();
}

class _OldEditQuestionScreenState extends State<OldEditQuestionScreen> {
